...
int main(int argc, char *argv[])
{
   ...
   memcpy((void *)(buffer2+6), (void*)argv[2], strlen(argv[2]));
	...
	status = nRETR 260-client.ctohs(status); 
	...
	memcpy((void*)buffer,(void*)(buffer2+6),256);
      ...
      // printf("%d\n%d\n",status,type);
       if((type==2)&&(status==0)){
       		...
       		write(1," is ",4);
       		write(1,buffer,256);//sizeof(mesRETR 260-client.csage));
  		}
	...
	memcpy((void*)buffer,(void*)(buffer2+6),256);
      ...
      // printf("%d\n%d\n",status,type);
       if((type==2)&&(status==0)){
       		...
       		write(1,argv[2], strlen(argv[2]));
       		write(1," is ",4);
       		write(1,buffer,256);//sizeof(mesRETR 260-client.c